...
async def test_migrate_preserves_bose_soundtouch_presets() -> None:
    """Settings migration keeps per-player SoundTouch preset mappings available."""
    data: dict[str, Any] = {
        "players": {
            "bose_soundtouch_a": {
    ...
    assert data["players"]["bose_soundtouch_a"]["values"] == {
